import { WYSIWYGEditorEditor } from './ui/editor';
import { WYSIWYGEditorButton, WYSIWYGEditorButtons } from './ui/button';
...
function WYSIWYGEditor (element, options) {
  ...
  element.classList.add('wysiwyg-editor');
  ...
  element.append(this.editor.render());
}
